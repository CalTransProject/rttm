...
import StackedArea from '../subcomponents/sub-graph/StackedAreaHist'; // Modify file & update
import Bar from '../subcomponents/sub-graph/BarHist'; // Modify & update
import PieChart from '../subcomponents/sub-graph/PieChartSec'; // PieChart shows perSec data
import StackedBar from '../subcomponents/sub-graph/StackedBarHist'; // Modify & update
import Density from '../subcomponents/sub-graph/DensityHist'; // Modify file & update path
