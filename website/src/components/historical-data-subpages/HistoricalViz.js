    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                setError('Failed to fetch per-Hour data. Please try again later.');
            }
        };
        fetchData();
    }, []);
