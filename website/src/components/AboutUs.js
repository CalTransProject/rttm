    ...
    return(
        <section>
          <div className="box">
                  ...
                  <h2>Our Project</h2>  
                      <p className='aboutUsP'>Vehicle detection plays an important role in analyzing traffic flow data for efficient planning in intelligent transportation. Machine Learning technology has been increasingly used for vehicle detection in both 2D real-time traffic flow video and 3D point clouds. Adverse weather conditions, such as fog, rain, snow, extreme wind, and other conditions prove to be challenging for 2D vehicle detection. 3D LiDAR point clouds can be more resistant to adverse weather conditions. Most of the existing research on 3D vehicle detection are used for autonomous vehicle driving with the LiDAR cameras are deployed on vehicles. There is a lack of research on real-time vehicle detection for intelligent transportation with LiDAR cameras deployed by highway/freeway. In this project, we propose to build a system that collects real-time traffic flow data through 3D LiDAR cameras, processes the 3D point cloud data for vehicle detection and classification, and provides a web-based service with vehicles detected and classified in real-time traffic flow and data visualization for statistical traffic flow data.</p>
                  </div>
                  <h2>Our team</h2>
                  ...
                  <div class="container">
                    <div class="membersDisplay">  
                      ...
                      <div class="member">
                        ...
                        <br></br>
                        <div class="description">Hello, My name is Robin. Im a CS undegrad student. And I worked on Web Development and Machine Learning</div>
